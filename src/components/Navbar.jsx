...
<header className="flex bg-white border-b py-4 sm:px-8 px-6 font-[sans-serif] min-h-[80px] tracking-wide relative z-50">
  <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
    <Link to={"/"}>
      <img src={Logos} alt="logo" className="w-36" />
    </Link>
    ...
    <div id="collapseMenu" className="lg:ml-10 max-lg:hidden lg:block">
      ...
      <ul className="lg:flex lg:gap-x-3 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
        ...
        <li className="max-lg:border-b max-lg:py-3 px-3">
          <Link to={"/new"} className="text-[#007bff] hover:text-[#007bff] text-[15px] block font-semibold">
            New
          </Link>
        </li>
        <li className="max-lg:border-b max-lg:py-3 px-3">
          <Link to={"/men"} className="text-[#333] hover:text-[#007bff] text-[15px] block font-semibold">
            Men
          </Link>
        </li>
        <li className="max-lg:border-b max-lg:py-3 px-3">
          <Link to={"/women"} className="text-[#333] hover:text-[#007bff] text-[15px] block font-semibold">
            Women
          </Link>
        </li>
        <li className="max-lg:border-b max-lg:py-3 px-3">
          <Link to={"/kids"} className="text-[#333] hover:text-[#007bff] text-[15px] block font-semibold">
            Kids
          </Link>
        </li>
      </ul>
    ...
    <div className="flex gap-x-6 gap-y-4 ml-auto">
      ...
      <div className="lg:hidden">
        <button>
          <svg xmlns="http://www.w3.org/2000/svg" className="fill-black" viewBox="0 0 40 30" width="24px">
            <path d="M0 2h40v4H0zm0 11h40v4H0zm0 11h40v4H0z"></path>
          </svg>
        </button>
      </div>
    </div>
