...
function DashboardLayout({ children }) {
  ...
  return (
    ...
    <div className="col-span-2 p-6">
        ...
        <Link to={'/user/addproduct'} className={`mx-4 p-2 ${window.location.pathname === '/user/profile' ? 'bg-blue-800 text-white' : 'bg-blue-400'} rounded-lg flex w-100 justify-center mb-4`}>Profile</Link> 
    </div>
